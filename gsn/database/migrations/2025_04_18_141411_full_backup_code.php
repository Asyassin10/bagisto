...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::statement("UPDATE `attributes` SET `backup_code` = 'f8S537tGHpDhDN1S' WHERE `attributes`.`id` = 135;");
        ...
        DB::statement("UPDATE `attributes` SET `backup_code` = 'ZeK2LLj4mx9JqTsN' WHERE `attributes`.`id` = 324;");
