...
return new class extends Migration {
    ...
    {
        //
        DB::statement("insert into `attributes` (`admin_name`, `type`, `default_value`, `regex`, `max_length`, `code`, `is_filterable`, `updated_at`, `created_at`) values ('Pre-requis', 'textarea', '', '', 300, 'ssoIzRjYVWIMbFsw', '', '2025-03-14 11:53:32', '2025-03-14 11:53:32')");

        DB::statement("insert into `attribute_translations` (`locale`, `attribute_id`, `name`) values ('en', 485, 'Pre-requis')");
        DB::statement("insert into `attribute_translations` (`locale`, `attribute_id`, `name`) values ('fr', 485, 'Pre-requis')");
        ...
        DB::statement("update `attribute_group_mappings` set `position` = 4 where `attribute_group_mappings`.`attribute_group_id` = 169 and `attribute_id` in (484)");
        ...
        DB::statement("insert into `attribute_group_mappings` (`attribute_group_id`, `attribute_id`, `position`) values (172, 485, 2)");
        DB::statement("delete from `attribute_group_mappings` where `attribute_group_mappings`.`attribute_group_id` = 172 and `attribute_group_mappings`.`attribute_id` in (152)");
