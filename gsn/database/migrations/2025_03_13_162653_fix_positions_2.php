...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::statement("UPDATE `attributes` SET `max_length` = '100' WHERE `attributes`.`id` = 463; ");
        DB::statement("UPDATE `attributes` SET `max_length` = '100' WHERE `attributes`.`id` = 482; ");
        DB::statement("insert into `attributes` (`admin_name`, `type`, `default_value`, `regex`, `max_length`, `code`, `is_filterable`, `updated_at`, `created_at`) values ('Confidentialité des données', 'textarea', '', '', 100, 'zJ3NeM3qprudqXRz', 0, '2025-03-13 16:30:40', '2025-03-13 16:30:40')");
        DB::statement("insert into `attribute_translations` (`locale`, `attribute_id`, `name`) values ('en', 484, 'Confidentialité des données')");
        DB::statement("insert into `attribute_translations` (`locale`, `attribute_id`, `name`) values ('fr', 484, 'Confidentialité des données')");
        ...
        DB::statement("update `attribute_group_mappings` set `position` = 4 where `attribute_group_mappings`.`attribute_group_id` = 165 and `attribute_id` in (463)");
        ...
        DB::statement("update `attribute_group_mappings` set `position` = 10 where `attribute_group_mappings`.`attribute_group_id` = 165 and `attribute_id` in (481)");
        ...
        DB::statement("insert into `attribute_group_mappings` (`attribute_group_id`, `attribute_id`, `position`) values (169, 484, 4)");
        DB::statement("delete from `attribute_group_mappings` where `attribute_group_mappings`.`attribute_group_id` = 169 and `attribute_group_mappings`.`attribute_id` in (432)");
        ...
        DB::statement("update `attribute_group_mappings` set `position` = 1 where `attribute_group_mappings`.`attribute_group_id` = 171 and `attribute_id` in (483)");
        DB::statement("update `attribute_group_mappings` set `position` = 2 where `attribute_group_mappings`.`attribute_group_id` = 171 and `attribute_id` in (482)");
