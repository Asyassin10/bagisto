...
>
    <head>
        ...
        {{-- GSN Custom Styles --}}
        <link rel="stylesheet" href="{{ asset('themes/gsn/css/font.css') }}">
        <link rel="stylesheet" href="{{ asset('themes/gsn/css/app.css') }}">
        <link rel="stylesheet" href="{{ asset('themes/gsn/css/modal.css') }}">
    ...
    <body>
        ...
        <script type="text/javascript" src="{{ asset('themes/gsn/js/app.js') }}"></script>
