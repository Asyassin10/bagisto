...
use App\Notifications\Channels\GSNNotificationChannel;
...
class NotififcationProductStatusChangedToNonActif extends GsnBaseNotification
{
    use Queueable;
    ...
    public function toCustomApi($notifiable): void
    {
        ...
        $response_mail_api = Http::withHeaders([
            "auth_token" => env("TOKEN_CNOEC")
                    ...
                    "subject" => "Une fiche est désactivée",
                    "code_template" => "gsmNoActiveSheet",
