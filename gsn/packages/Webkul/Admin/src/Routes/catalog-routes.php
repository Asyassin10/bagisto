...
Route::group(['middleware' => ['admin'], 'prefix' => config('app.admin_url')], function () {
    Route::prefix('catalog')->group(function () {
        ...
        Route::controller(ProductController::class)->prefix('products')->group(function () {
            ...
            Route::delete('delete/{product_id}', 'deleteById')->name('admin.catalog.product.delete');

            Route::post('create', 'store')->name('admin.catalog.products.store');
            Route::get('validateInvalidateProductToggle/{product_id}', 'validateInvalidateProductToggle')->name('admin.catalog.products.validateInvalidateProductToggle');

            Route::get('copy/{id}', 'copy')->name('admin.catalog.products.copy');

            Route::get('edit/{id}', 'edit')->name('admin.catalog.products.edit');
            Route::get('visualize/{slug}', 'visualize')->name('admin.catalog.products.visualize');
            ...
            Route::post('mass-set-congre-partner/{is_congrate_partner}', 'massSetPartnetAgreed')->name('admin.catalog.products.mass_set_congre_partner');
