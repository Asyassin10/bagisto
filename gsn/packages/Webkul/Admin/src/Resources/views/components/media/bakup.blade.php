...
@pushOnce('scripts')
            ...
            <div class="invisible absolute bottom-0 top-0 flex w-full flex-col justify-between bg-white p-3 opacity-80 transition-all group-hover:visible dark:bg-gray-900">
                ...
                <div class="flex justify-between">
                    ...
                    <input
                        ...
                        class="hidden"
                        accept="image/*"
                        :id="$.uid + 'imageInput' + index"
                        :ref="$.uid + 'imageInput' + index"
                        @change="edit"
                    />
                </div>
            </div>
    ...
    <script type="module">
        ...
        app.component('v-media-image-item', {
            ...
            methods: {
                edit() {
                    let imageInput = this.$refs[this.$.uid + 'imageInput' + this.index];
                ...
                setFile(file) {
                    ...
                    this.$refs[this.$.uid + 'imageInput' + this.index].files = dataTransfer.files;
                },
