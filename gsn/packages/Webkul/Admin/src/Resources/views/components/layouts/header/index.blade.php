...
<header
    class="sticky top-0 z-[10001] flex items-center justify-between border-b bg-white px-4 py-2.5 dark:border-gray-800 dark:bg-gray-900">
    <div class="flex items-center gap-1.5">
        <!-- Hamburger Menu -->
        <i class="icon-menu hidden cursor-pointer rounded-md p-1.5 text-2xl hover:bg-gray-100 dark:hover:bg-gray-950 max-lg:block"
        ...
        <a href="{{ route('admin.dashboard.index') }}">
            @if ($logo = core()->getConfigData('general.design.admin_logo.logo_image'))
                <img class="h-10"
                    src="https://img.leboncoin.fr/api/v1/lbcpb1/images/7f/c3/2f/7fc32f0cad524d76710896113d54ab0f6b10a8ff.jpg?rule=ad-image"
                    alt="GuideSolution" style="
            height: 3.5rem;
        ">
            @else
                <img class="h-10"
    ...
    <div class="flex items-center gap-2.5">
        ...
        <a href="{{ route('shop.home.index') }}" target="_blank" class="flex">
            <span
                class="p-1.5 text-2xl transition-all hover:bg-gray-100 dark:hover:bg-gray-950"
                title="Retourner à l'accueil">

                 <svg fill="#737373" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="25px" height="25px">    <path d="M 25 1.0507812 C 24.7825 1.0507812 24.565859 1.1197656 24.380859 1.2597656 L 1.3808594 19.210938 C 0.95085938 19.550938 0.8709375 20.179141 1.2109375 20.619141 C 1.5509375 21.049141 2.1791406 21.129062 2.6191406 20.789062 L 4 19.710938 L 4 46 C 4 46.55 4.45 47 5 47 L 19 47 L 19 29 L 31 29 L 31 47 L 45 47 C 45.55 47 46 46.55 46 46 L 46 19.710938 L 47.380859 20.789062 C 47.570859 20.929063 47.78 21 48 21 C 48.3 21 48.589063 20.869141 48.789062 20.619141 C 49.129063 20.179141 49.049141 19.550938 48.619141 19.210938 L 25.619141 1.2597656 C 25.434141 1.1197656 25.2175 1.0507812 25 1.0507812 z M 35 5 L 35 6.0507812 L 41 10.730469 L 41 5 L 35 5 z"/></svg>
            </span>
        </a>
        ...
        <x-admin::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
            <x-slot:toggle>
                @if ($admin->image)
                    <button
                        ...
                        <img src="{{ $admin->image_url }}" class="w-full" />
                    </button>
                @else
                    <button
            ...
            <x-slot:content class="!p-0">
                <div class="flex items-center gap-1.5 border border-b-gray-300 px-5 py-2.5 dark:border-gray-800">
                    <img src="{{ url('cache/logo/bagisto.png') }}" width="24" height="24" />
                    ...
                    @if ($menuItem->key != 'societe')
                        <div class="group/item relative">
                            ...
                            @if ($menuItem->haveChildren())
                                <div
                                    class="{{ $menuItem->isActive() ? ' !grid bg-gray-100 dark:bg-gray-950' : '' }} hidden min-w-[180px] ltr:pl-10 rtl:pr-10 pb-2 rounded-b-lg z-[100]">
