                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="admin_name" rules="required"
                                :value="old('admin_name')" :label="trans('admin::app.catalog.attributes.create.admin')"
                        ...
                        <x-admin::form.control-group class="last:!mb-0">
                            ...
                            <x-admin::form.control-group.control type="text" :name="$locale->code . '[name]'"
                                :value="old($locale->code . '[name]')" :placeholder="$locale->name" />
                        </x-admin::form.control-group>
                        @endforeach
                    </div>

                    <!-- Options -->
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900" v-if="swatchAttribute && (
                            ...
                            <div class="flex gap-4 max-sm:flex-wrap">
                                ...
                                <x-admin::form.control-group class="mb-2.5 w-full">
                                    ...
                                    <x-admin::form.control-group.control type="select" id="swatchType"
                                        name="swatch_type" :value="old('swatch_type')" v-model="swatchType"
                                ...
                                <div class="mb-2.5 w-full">
                                    ...
                                    <div class="!mb-0 flex w-max cursor-pointer select-none items-center gap-2.5 p-1.5">
                                        <input type="checkbox" class="peer hidden" id="empty_option" name="empty_option"
                                            v-model="isNullOptionChecked" for="empty_option"
                            ...
                            <template v-if="this.options?.length">
                                ...
                                <x-admin::table>
                                    ...
                                    <draggable tag="tbody" ghost-class="draggable-ghost" handle=".icon-drag"
                                        v-bind="{animation: 200}" :list="options" item-key="id">
                                        <template #item="{ element, index }">
                                            <x-admin::table.thead.tr class="hover:bg-gray-50 dark:hover:bg-gray-950">
                                                ...
                                                <x-admin::table.td class="!px-0 text-center">
                                                    ...
                                                    <input type="hidden" :name="'options[' + element.id + '][position]'"
                                                        :value="index" />
                                                </x-admin::table.td>
                        ...
                        <x-slot:header>
                            ...
                            <x-slot:content>
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control type="select" id="type" class="cursor-pointer"
                                        name="type" rules="required" :value="old('type')" v-model="attributeType"
                        ...
                        <x-slot:header>
                            ...
                            <x-slot:content>
                                ...
                                <x-admin::form.control-group v-show="inputValidation && (validationType == 'regex')">
                                    ...
                                    <x-admin::form.control-group.control type="text" name="regex" :value="old('regex')"
                                ...
                                <x-admin::form.control-group class="!mb-5"
                                    v-if="swatchAttribute && (attributeType == 'text') || (attributeType == 'textarea') || (attributeType == 'price')">
                                    <x-admin::form.control-group.label>
                                        @lang('admin::app.catalog.attributes.create.max-length')
                                    </x-admin::form.control-group.label>

                                    <x-admin::form.control-group.control type="text" name="max_length"
                                ...
                                <x-admin::form.control-group class="mb-2.5 w-full"
                                    ...
                                    <x-admin::form.control-group.control type="select" id="is_alpha_numeric"
                                        name="is_alpha_numeric" :value="old('is_alpha_numeric')" v-model="is_alpha_numeric"
                                        >
                                ...
                                <x-admin::form.control-group class="!mb-2 flex items-center gap-2.5">
                                    <x-admin::form.control-group.control type="checkbox" id="is_required"
                                        name="is_required" value="1" for="is_required" />
                            ...
                            <x-slot:content>
                                ...
                                <x-admin::form.control-group class="!mb-2 flex select-none items-center gap-2.5">
                                    <x-admin::form.control-group.control type="checkbox" id="value_per_locale"
                                        name="value_per_locale" value="1" for="value_per_locale" />
                                ...
                                <x-admin::form.control-group class="!mb-2 flex select-none items-center gap-2.5">
                                    <x-admin::form.control-group.control type="checkbox" id="value_per_channel"
                                        name="value_per_channel" value="1" for="value_per_channel" />
                                ...
                                <x-admin::form.control-group class="!mb-2 flex select-none items-center gap-2.5">
                                    <x-admin::form.control-group.control type="checkbox" id="is_visible_on_front"
                                        name="is_visible_on_front" value="1" for="is_visible_on_front" />
                            ...
                            <x-slot:content>
                                <div class="grid" v-if="swatchType == 'image' || swatchType == 'color'">
                                    ...
                                    <x-admin::form.control-group class="w-full" v-if="swatchType == 'image'">
                                        ...
                                        <x-admin::form.control-group.control type="image" name="swatch_value"
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <x-admin::form.control-group class="mb-2.5 w-full">
                                        ...
                                        <x-admin::form.control-group.control type="text" :name="$locale->code"
                        ...
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                ...
                                this.$emitter.emit('add-flash', {
                                    type: 'success',
                                    message: "@lang('admin::app.catalog.attributes.create.option-deleted')"
                                });
                            }
                        });
                    },
