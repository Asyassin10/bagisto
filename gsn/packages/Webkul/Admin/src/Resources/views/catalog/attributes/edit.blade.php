<x-admin::layouts>
    ...
    <!-- Input Form -->
    <x-admin::form :action="route('admin.catalog.attributes.update', $attribute->id)" enctype="multipart/form-data" method="PUT">
        ...
        <script type="text/x-template" id="v-edit-attributes-template">
            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex flex-1 flex-col gap-2 overflow-auto max-xl:flex-auto">
                    ...
                    {!! view_render_event('bagisto.admin.catalog.attributes.edit.card.label.before', ['attribute' =>
                    $attribute]) !!}
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group class="last:!mb-0">
                            ...
                            <x-admin::form.control-group.control type="text" :name="$locale->code . '[name]'"
                    ...
                    {!! view_render_event('bagisto.admin.catalog.attributes.edit.card.label.after', ['attribute' =>
                    $attribute]) !!}

                    <!-- Options -->
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900 {{ in_array($attribute->type, ['select', 'multiselect', 'checkbox', 'price']) ?: 'hidden' }}"
                        v-if="showSwatch">
                        <div class="mb-3 flex items-center justify-between">
                            ...
                            <!-- Add Row Button -->
                            <div class="secondary-button text-sm" @click="$refs.addOptionsRow.toggle();swatchValue=''">
                        ...
                        <div class="mt-4 overflow-x-auto">
                            <div class="flex items-center gap-4 max-sm:flex-wrap">
                                ...
                                <x-admin::form.control-group class="mb-2.5 w-full" v-if="this.showSwatch">
                                    ...
                                    <x-admin::form.control-group.control type="select" id="swatchType"
                                        name="swatch_type" v-model="swatchType" @change="showSwatch=true">
                                ...
                                <div class="w-full">
                                    <div class="!mb-0 flex w-max cursor-pointer select-none items-center gap-2.5">
                                        <input type="checkbox" name="empty_option" id="empty_option" for="empty_option"
                                            class="peer hidden" v-model="isNullOptionChecked"
                                            @click="$refs.addOptionsRow.toggle()">

                                        <label for="empty_option"
                                ...
                                <x-admin::table>
                                    <x-admin::table.thead class="text-sm font-medium dark:bg-gray-800">
                                        <x-admin::table.thead.tr>
                                            ...
                                            <!-- Swatch Select -->
                                            <x-admin::table.th
                                                v-if="showSwatch && (swatchType == 'color' || swatchType == 'image')">
                                    ...
                                    <!-- Draggable Component -->
                                    <draggable tag="tbody" ghost-class="draggable-ghost" handle=".icon-drag"
                                        v-bind="{animation: 200}" :list="optionsData" item-key="id">
                                        <template #item="{ element, index }">
                                            <x-admin::table.thead.tr class="hover:bg-gray-50 dark:hover:bg-gray-950"
                                                v-show="! element.isDelete">
                                                <input type="hidden" :name="'options[' + element.id + '][isNew]'"
                                                    :value="element.isNew">

                                                <input type="hidden" :name="'options[' + element.id + '][isDelete]'"
                                                    :value="element.isDelete">

                                                <!-- Draggable Icon -->
                                                <x-admin::table.td class="!px-0 text-center">
                                                    <i
                                                        class="icon-drag cursor-grab text-xl transition-all group-hover:text-gray-700"></i>
                                                ...
                                                <x-admin::table.td
                                                    ...
                                                    <div v-if="swatchType == 'image'">
                                                        <img :src="element.swatch_value_url || '{{ bagisto_asset('images/product-placeholders/front.svg') }}'"
                                                            :ref="'image_' + element.id" class="h-[50px] w-[50px]">

                                                        <input type="file"
                                                            :name="'options[' + element.id + '][swatch_value]'"
                                                            class="hidden" :ref="'imageInput_' + element.id" />
                                                    </div>

                                                    <!-- Swatch Color -->
                                                    <div v-if="swatchType == 'color'">
                                                        <div class="h-[25px] w-[25px] rounded-md border border-gray-200 dark:border-gray-800"
                            ...
                            <template v-else>
                                <div class="grid justify-items-center gap-3.5 px-2.5 py-10">
                                    ...
                                    <img class="h-[120px] w-[120px] dark:mix-blend-exclusion dark:invert"
                                    ...
                                    <!-- Add Row Button -->
                                    <div class="secondary-button text-sm" @click="$refs.addOptionsRow.toggle()">
                                        @lang('admin::app.catalog.attributes.edit.add-row')
                                    </div>
                                </div>
                            </template>
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    {!! view_render_event('bagisto.admin.catalog.attributes.edit.card.accordian.general.before',
                    ['attribute' => $attribute]) !!}
                        ...
                        <x-slot:header>
                            ...
                            <x-slot:content>
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control type="text" class="cursor-not-allowed"
                                        name="code" rules="required" :value="$selectedOption"
                                        :disabled="(boolean) $selectedOption" readonly
                                        :label="trans('admin::app.catalog.attributes.edit.code')"
                                        :placeholder="trans('admin::app.catalog.attributes.edit.code')" />

                                    <x-admin::form.control-group.control type="hidden" name="code"
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control type="select" id="type"
                                        class="cursor-not-allowed" name="type" rules="required" :value="$selectedOption"
                                        :disabled="(boolean) $selectedOption"
                                        :label="trans('admin::app.catalog.attributes.edit.type')">
                                        <!-- Here! All Needed types are defined -->
                                        @foreach(['text', 'textarea', 'price', 'boolean', 'select', 'multiselect',
                                        'datetime', 'date', 'image', 'file', 'checkbox'] as $type)
                                        <option value="{{ $type }}" {{ $selectedOption==$type ? 'selected' : '' }}>
                                            @lang('admin::app.catalog.attributes.edit.'. $type)
                                        </option>
                                        @endforeach
                                    </x-admin::form.control-group.control>

                                    <x-admin::form.control-group.control type="hidden" name="type"
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control type="switch" name="enable_wysiwyg" value="1"
                                ...
                                <x-admin::form.control-group class="!mb-0">
                                    ...
                                    <x-admin::form.control-group.control type="text" name="default_value"
                    ...
                    {!! view_render_event('bagisto.admin.catalog.attributes.edit.card.accordian.general.after',
                    ['attribute' => $attribute]) !!}

                    {!! view_render_event('bagisto.admin.catalog.attributes.edit.card.accordian.validations.before',
                    ['attribute' => $attribute]) !!}
                        ...
                        <x-slot:header>
                            ...
                            <x-slot:content>
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control type="select" class=""
                                        name="validation" :value="$attribute->validation" >
                                        <!-- Here! All Needed types are defined -->
                                ...
                                @endif
                                @if($attribute->type == 'text' || $attribute->type == "price" || $attribute->type == "textarea")
                                <x-admin::form.control-group class="!mb-5">
                                    <x-admin::form.control-group.label>
                                        @lang('admin::app.catalog.attributes.create.max-length')
                                    </x-admin::form.control-group.label>
                                     @php
                                    $max_length = old('max_length') ?: $attribute->max_length;
                                    @endphp
                                    <x-admin::form.control-group.control type="text" :value=$max_length name="max_length"
                                        :label="trans('admin::app.catalog.attributes.create.max-length')" />
                                </x-admin::form.control-group>
                                @endif
                                @if($attribute->type == 'text' || $attribute->type == "price" || $attribute->type == "textarea")
                               <x-admin::form.control-group class="mb-2.5 w-full"
                                    ...
                                    <x-admin::form.control-group.label>
                                     ...
                                     @php
                                    $is_alpha_numeric = old('is_alpha_numeric') ?: $attribute->is_alpha_numeric;
                                    @endphp
                                    <x-admin::form.control-group.control type="select" id="is_alpha_numeric"
                                        name="is_alpha_numeric" :value="$is_alpha_numeric" v-model="is_alpha_numeric"
                                        >
                                        @foreach ([["1" => "oui"], ["0"=>"non"]] as $item)
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <v-field type="text" name="regex" :value="{{ json_encode($attribute->regex) }}"
                                        label="{{ trans('admin::app.catalog.attributes.create.regex') }}"
                                        v-slot="{ field }">
                                        <input type="text" name="regex" id="regex" v-bind="field"
                                ...
                                <x-admin::form.control-group class="!mb-2 flex select-none items-center gap-2.5">
                                    ...
                                    <x-admin::form.control-group.control type="hidden" name="is_required"
                                        :value="(boolean) $selectedOption" />

                                    <x-admin::form.control-group.control type="checkbox" name="is_required"
                                        id="is_required" for="is_required" value="1"
                                ...
                                <x-admin::form.control-group class="!mb-0 flex select-none items-center gap-2.5">
                                    <x-admin::form.control-group.control type="checkbox" id="is_unique" name="is_unique"
                                        value="1" for="is_unique" :checked="(boolean) $attribute->is_unique"
                    ...
                    {!! view_render_event('bagisto.admin.catalog.attributes.edit.card.accordian.validations.after',
                    ['attribute' => $attribute]) !!}

                    {!! view_render_event('bagisto.admin.catalog.attributes.edit.card.accordian.configuration.before',
                    ['attribute' => $attribute]) !!}
                    ...
                    <x-admin::accordion>
                        <x-slot:header>
                            ...
                            <x-slot:content>
                                <!-- Value Per Locale -->
                                <x-admin::form.control-group
                                    class="!mb-2 flex select-none items-center gap-2.5 opacity-70">
                                    @php
                                    $valuePerLocale = old('value_per_locale') ?? $attribute->value_per_locale;
                                    @endphp

                                    <x-admin::form.control-group.control type="checkbox" id="value_per_locale"
                                        name="value_per_locale" value="1" :checked="(boolean) $valuePerLocale"
                                    ...
                                    <x-admin::form.control-group.control type="hidden" name="value_per_locale"
                                ...
                                <x-admin::form.control-group
                                    ...
                                    <x-admin::form.control-group.control type="checkbox" id="value_per_channel"
                                        name="value_per_channel" value="1" :checked="(boolean) $valuePerChannel"
                                    ...
                                    <x-admin::form.control-group.control type="hidden" name="value_per_channel"
                                ...
                                <x-admin::form.control-group class="!mb-2 flex select-none items-center gap-2.5">
                                    ...
                                    <x-admin::form.control-group.control type="checkbox" id="is_filterable"
                                        name="is_filterable" value="1" for="is_filterable"
                                    ...
                                    <x-admin::form.control-group.control type="hidden" name="is_filterable"
                                ...
                                <x-admin::form.control-group class="!mb-2 flex select-none items-center gap-2.5">
                                    ...
                                    <x-admin::form.control-group.control type="checkbox" id="is_configurable"
                                        name="is_configurable" value="1" for="is_configurable"
                                    ...
                                    <x-admin::form.control-group.control type="hidden" name="is_configurable"
                                ...
                                <x-admin::form.control-group class="!mb-2 flex select-none items-center gap-2.5">
                                    ...
                                    <x-admin::form.control-group.control type="checkbox" id="is_visible_on_front"
                                        name="is_visible_on_front" for="is_visible_on_front" value="1"
                                    ...
                                    <x-admin::form.control-group.control type="hidden" name="is_visible_on_front"
                                ...
                                <x-admin::form.control-group class="!mb-0 flex select-none items-center gap-2.5">
                                    ...
                                    <x-admin::form.control-group.control type="checkbox" id="is_comparable"
                                        name="is_comparable" value="1" for="is_comparable"
                                    ...
                                    <x-admin::form.control-group.control type="hidden" name="is_comparable"
                    ...
                    {!!
                    view_render_event('bagisto.admin.catalog.attributes.edit.card.accordian.configuration.configuration.after',
                    ['attribute' => $attribute]) !!}
                </div>
            </div>
                            ...
                            <x-slot:content>
                                <div class="grid">
                                    ...
                                    <x-admin::form.control-group class="w-full" v-if="swatchType == 'image'">
                                        ...
                                        <div class="hidden">
                                            <x-admin::media.images name="swatch_value[]"
                                    ...
                                    <x-admin::form.control-group class="w-2/6" v-if="swatchType == 'color'">
                                        ...
                                        <x-admin::form.control-group.control type="color" name="swatch_value"
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <x-admin::form.control-group.control type="hidden" name="isNew"
                                        ::value="optionIsNew" />

                                    <!-- Admin Input -->
                                    <x-admin::form.control-group class="mb-2.5 w-full">
                                        <x-admin::form.control-group.label
                                            ::class="{ 'required' : ! isNullOptionChecked }">
                                            @lang('admin::app.catalog.attributes.edit.admin')
                                        </x-admin::form.control-group.label>

                                        <x-admin::form.control-group.control type="text" name="admin_name"
                                    ...
                                    <x-admin::form.control-group class="mb-2.5 w-full">
                                        ...
                                        <x-admin::form.control-group.control type="text"
                                            ...
                                            :label="$locale->name" :placeholder="$locale->name" />
                        ...
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                ...
                                this.$emitter.emit('add-flash', {
                                    type: 'success',
                                    message: "@lang('admin::app.catalog.attributes.edit.option-deleted')"
                                });
                            }
                        });
                    },
